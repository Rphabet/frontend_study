// "showRange": "20210715~20210715"   << 이건 위에 검색박스에
// "rank": "1"
// 포스터 컬럼
// 제목: "movieNm": "랑종"
// 개봉일: "openDt": "2021-07-14"
// 상세보기: 버튼 하나

// 데이터를 갖고와서 만들어 붙이는거임!!! ////
//////////////////////////////////////////////////////////////////////////////////
// function search_function2() {
//     // alert('you clicked search button!!!!'); // ㅇㅋ 성공
//     let date_value = $('[type=date]').val();
//     // alert(date_value); ㅇㅋ 날짜 불러오기 성공
//     // alert(typeof date_value);  // string 인거 체크했삼~
//     date_value_wo_dash = date_value.replaceAll("-","");
//     alert(date_value_wo_dash);
// }
...
$(function() {
    $('#searchId').on('click', function(event) {
        ...
        $.ajax({
            ...
            type : 'GET',
            timeout : 3000,      // 3초안에 데이터 호출에 실패한다면, 이 ajax호출은 실패한걸로 간주하겟어! 라는 소리임
            data : {
            ...
            success : function(result) {
                ...
                // 이 success 안에서는 화면에 표시할 HTML을 만들어서 적절한 위치에 붙이자!

                // 포문도 사용가능
                // for(let i=0; i<10; i++) {
                //     let BoxList = result.boxOfficeResult.dailyBoxOfficeList[i];
                ...
                // 무슨 처리전에 화면 싹다 날려야함. 새로고침 느낌으로
                $('#myTbody').empty();

                // alert(result.boxOfficeResult.dailyBoxOfficeList[0].movieNm);  // 호출 성공했다. 이제 리스트를 채우면 됨.
                ...
                $.each(result.boxOfficeResult.dailyBoxOfficeList, function(idx, BoxOfficeList) {
...
//     $('div > button').on('click', function(event) {
//         // alert("Test if the button works")   // ok button works
//         $.ajax({
//             async : true,
//             url : 'http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json',
//             type : 'GET',
